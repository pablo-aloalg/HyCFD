...
route="/lustre/geocean/WORK/users/alonsoap/personal/estancia_NUS_2026/HyCFD/outputs/openfoam_cases_longwaves/$formated_case"
cd $route
...
mpirun -np 12 waveFoam -parallel > waveFoam.log 2>&1
